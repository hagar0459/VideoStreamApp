...
public class MediaSamples {
    ...
    static {
        ...
        videoSamples.add(new MediaSampleList("دورى أبطال السعودية", "http://intigralvod1-vh.akamaihd.net/i/3rdparty/Season2017_2018/10_12_2017_Hilal_fath/Highlights/high_,256,512,768,1200,.mp4.csmil/master.m3u8"));
    }
